...
from modeling import CondenserForPretraining, RobertaCondenserForPretraining, DebertaV2CondenserForPretraining
...
CONDENSER_TYPE_MAP = {
    ...
    'deberta-v2': DebertaV2CondenserForPretraining
}
...
def main():
    ...
    print("Before train dataset", data_args.train_path)
    train_set = load_dataset(
        'json',
        data_files=data_args.train_path[0],
        block_size=2**25,
    )['train']
    print("Before validate dataset",data_args.validation_file)
